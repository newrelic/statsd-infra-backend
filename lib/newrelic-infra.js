...
const composePayload = function nriPayload(data) {
    ...
    Object.keys(v1data).forEach(function(entityId) {
      ...
      Object.keys(metrics).forEach(function(eventType) {
        ...
        if (debug) {
          ...
          if (metricsLength > 100) {
            l.log(`The event has more than 100 metrics and will be ignored by the agent. Metrics length: ${metricsLength}`);
          }
        }
  ...
  const v2Payload = function(v2data) {
    ...
    Object.keys(v2data).forEach(function(entityId) {
      ...
      const metricSets = [];
      Object.keys(metrics).forEach(function(eventType) {
        metricSets.push(Object.assign({ event_type: eventType }, metrics[eventType]));
      });
