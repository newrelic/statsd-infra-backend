...
var collectMetrics = function nriCollectMetrics(rawMetrics, rules) {
  ...
  globalLogger.log("DAN RAWMETRICS: " + Object.keys(rawMetrics))

  globalLogger.log("DAN COUNTERS: " + rawMetrics.counters)
...
var composePayload = function nriPayload(data) {
  ...
  var v1Payload = function (v1data) {
    ...
    globalLogger.log("DAN V1PAYLOAD" + Object.keys(v1data))
  ...
  var v2Payload = function(v2data) {
    ...
    globalLogger.log("DAN V2DATA " + Object.keys(v2data))
