...
var collectMetrics = function nriCollectMetrics(rawMetrics, rules) {
  ...
  var counters_tags = rawMetrics.counters_tags || {};
  var sets_tags = rawMetrics.sets_tags || {};
  var counter_rates_tags = rawMetrics.counter_rates_tags || {};
  var timer_data_tags = rawMetrics.timer_data_tags || {};
  var timers_tags = rawMetrics.timers_tags || {}
  ...
  var extractSchemaFields = function(key, schema) {
    ...
    // Append gauges tags if matching
    Object.keys(gauges_tags).forEach(function(metric_key){
      if(metric_key === key) {
        gauges_tags[metric_key].forEach(function(tagObject){
    ...
    // Append counters tags if matching
    Object.keys(counters_tags).forEach(function(metric_key){
      if(metric_key === key) {
        counters_tags[metric_key].forEach(function(tagObject){
          tag = Object.keys(tagObject)[0];
          fields[tag] = tagObject[tag];
        })
      }
    ...
    // Append counters rates tags if matching    
    Object.keys(counter_rates_tags).forEach(function(metric_key){
      if(metric_key === key) {
        counter_rates_tags[metric_key].forEach(function(tagObject){
          tag = Object.keys(tagObject)[0];
          fields[tag] = tagObject[tag];
        })
      }
    ...
    // Append timer data tags if matching
    Object.keys(timer_data_tags).forEach(function(metric_key){
      if(metric_key === key) {
        timer_data_tags[metric_key].forEach(function(tagObject){
          tag = Object.keys(tagObject)[0];
          fields[tag] = tagObject[tag];
        })
      }
    ...
    // Append timers tags if matching
    Object.keys(timers_tags).forEach(function(metric_key){
      if(metric_key === key) {
        timers_tags[metric_key].forEach(function(tagObject){
          tag = Object.keys(tagObject)[0];
          fields[tag] = tagObject[tag];
        })
      }
    ...
    // Append sets tags if matching
    Object.keys(sets_tags).forEach(function(metric_key){
      if(metric_key === key) {
        sets_tags[metric_key].forEach(function(tagObject){
          tag = Object.keys(tagObject)[0];
          fields[tag] = tagObject[tag];
        })
      }
